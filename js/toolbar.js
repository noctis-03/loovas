...
// ══════════════════════════════════════════════════════
//  위성 요소 위치 계산
//  · mode-bar  : toolbar 왼쪽에 수직으로 붙음
//  · ur-cluster: toolbar 오른쪽에 수직으로 붙음
// ══════════════════════════════════════════════════════
...
// 하위 호환 — toolOrb.js 가 color-bar id를 직접 참조하는 곳이 있어
// color-bar 클래스 추가/제거 대신 color-tray로 라우팅
